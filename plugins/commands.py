...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('♻️  ᴘʟᴇᴀꜱᴇ ꜱʜᴀʀᴇ  ♻️', url=f"https://telegram.me/share/url?url=telegram.me/searchinggroupmovie"),
            ]
            ]
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            ...
            btn = [[
                ...
                InlineKeyboardButton('🎪  WELLCOME MY GROUP  🎪', url='https://telegram.me/searchinggroupmovie')
            ]]
            await message.reply_photo(
