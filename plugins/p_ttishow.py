...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url='https://telegram.me/New123459')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton('🥷 ʜᴇʟᴘ 🥷', url='https://telegram.me/New123459'),
                    InlineKeyboardButton('♻️ ᴜᴘᴅᴀᴛᴇꜱ ♻️', url='https://telegram.me/movieallupdate')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
